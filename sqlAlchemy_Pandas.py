...
engine = create_engine("sqlite:///mydb_hww.db", echo=True)
...
print("Before update: ")
db_before = pd.read_sql(session.query(Student).statement, engine)
print(db_before)
# for student in res:
#     print(student)
...
print("After update: ")
db_after = pd.read_sql(session.query(Student).statement, engine)
print(db_after)
# for stud in res2:
#     print(stud)
...
cursor.execute("INSERT INTO students_details VALUES (1, 1, 85)")  # John -> Math -> 85 marks
cursor.execute("INSERT INTO students_details VALUES (2, 2, 90)")  # Jane -> Science -> 90 marks
